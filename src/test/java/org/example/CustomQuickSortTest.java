...
public class CustomQuickSortTest {
    ...
    public void test1() {
        ...
        Assertions.assertEquals(String.format("CustomArrayList [size=0, data=]%n"), emptyList.toString());
    }
    ...
    public void test2() {
        ...
        Assertions.assertEquals(String.format("CustomArrayList [size=1, data=5]%n"), customArrayList.toString());
    }
    ...
    public void test3() {
        ...
        Assertions.assertEquals(String.format("CustomArrayList [size=5, data=1,2,3,4,5]%n"), customArrayList.toString());
    }
    ...
    public void test4() {
        ...
        Assertions.assertEquals(String.format("CustomArrayList [size=6, data=1,2,2,3,4,5]%n"), customArrayList.toString());
    }
